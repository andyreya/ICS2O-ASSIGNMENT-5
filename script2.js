...
// the function changes the input into an integer and creates a value for the radius. It calculates the value of the circumference and rounds it to two decimal places. It then displays the statement 'The circumference of this circle is ' and the circumference afterwards
